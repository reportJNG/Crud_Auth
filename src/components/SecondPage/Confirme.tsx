    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="relative bg-card border border-border rounded-lg shadow-lg max-w-md w-full p-6 animate-in fade-in-0 zoom-in-95 duration-200">
          <button
            className="absolute right-4 top-4 p-1 rounded-sm opacity-70 hover:opacity-100 hover:bg-accent transition-all focus:outline-none focus:ring-2 focus:ring-ring cursor-pointer"
            onClick={no}
          >
            <X className="h-4 w-4" />
          </button>
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex gap-3 w-full">
              <button
                onClick={no}
                className="flex-1 px-4 py-2 text-sm font-medium rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring cursor-pointer"
              >
                Cancel
              </button>
              <button
                onClick={yes}
                className="flex-1 px-4 py-2 text-sm font-medium rounded-md bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-colors focus:outline-none focus:ring-2 focus:ring-destructive cursor-pointer"
              >
                Confirm Delete
              </button>
            </div>
